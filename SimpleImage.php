...
class SimpleImage
{
    ...
    function resize($width, $height, $saveAlpha = false)
    {
        ...
        if ($this->image_type == IMAGETYPE_GIF || $this->image_type == IMAGETYPE_PNG) {
            ...
            if ($current_transparent != -1) {
                ...
                $alpha = $saveAlpha ? 127 : 0;
                $color = imagecolorallocatealpha($new_image, 0, 0, 0, $alpha);
                imagefill($new_image, 0, 0, $color);
                imagesavealpha($new_image, $saveAlpha);
            }
        }
